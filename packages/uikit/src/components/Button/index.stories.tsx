...
export const Anchors: React.FC<React.PropsWithChildren> = () => {
  return (
    <>
            ...
            <Box key={variant} mb="32px">
              {Object.values(scales).map((scale) => {
                return (
                  <Button
                    as="a"
                    href="https://app.diffusiondao.org"
                    key={scale}
                    variant={variant}
                    scale={scale}
                    external
      ...
      <Box>
        <Button as="a" href="https://app.diffusiondao.org" mr="8px" external disabled>
          Disabled
        </Button>
        <Button as="a" href="https://app.diffusiondao.org" variant="secondary" external disabled>
          Disabled
        </Button>
      </Box>
    </>
